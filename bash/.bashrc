...
if [ -f ${HOME}/.config/tryton/tryton.env ] ; then
  source ${HOME}/.config/tryton/tryton.env
fi

if [ -f ${HOME}/bin/cherrypick.sh ] ; then
  source ${HOME}/bin/cherrypick.sh
fi
